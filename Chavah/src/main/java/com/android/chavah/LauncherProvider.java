...
import com.android.chavah.AutoInstallsLayout.LayoutParserCallback;
...
import com.android.chavah.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as chavah never supported a lower
                // version of the DB.
                case 12: {
                ...
                case 16: {
                    ...
                    Log.w(TAG, "Found pre-11 Chavah, preparing update");
