...
package com.android.chavah.settings;

import android.content.Context;
import android.content.SharedPreferences;

public final class SettingsProvider {
    public static final String SETTINGS_KEY = "chavah_preferences";
    ...
    public static final String SETTINGS_UI_WORKSPACE_EFFECT = "ui_workspace_effect";
