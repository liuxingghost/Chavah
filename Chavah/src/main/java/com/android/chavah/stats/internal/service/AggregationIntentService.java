...
package com.android.chavah.stats.internal.service;
...
import com.android.chavah.LauncherAppState;
import com.android.chavah.stats.external.StatsUtil;
import com.android.chavah.stats.external.TrackingBundle;
import com.android.chavah.stats.internal.db.DatabaseHelper;
import com.android.chavah.stats.internal.model.CountAction;
import com.android.chavah.stats.internal.model.CountOriginByPackageAction;
import com.android.chavah.stats.internal.model.ITrackingAction;
import com.android.chavah.stats.internal.model.RemoteFolderAction;
import com.android.chavah.stats.internal.model.TrackingEvent;
import com.android.chavah.stats.util.Logger;
...
public class AggregationIntentService extends IntentService {
    ...
    private static final String TRACKING_ID = "com.cyanogenmod.chavah";
    public static final String ACTION_AGGREGATE_AND_TRACK =
            "com.cyanogenmod.chavah.AGGREGATE_AND_TRACK";
    ...
    private boolean isTrebuchetDefaultLauncher() {
        ...
        for (ComponentName activity : activities) {
            if (myPackageName.equals(activity.getPackageName())) {
                Logger.logd(TAG, "Chavah IS default launcher!");
                return true;
            }
        }
        Logger.logd(TAG, "Chavah IS NOT default launcher!");
        return false;
    }
