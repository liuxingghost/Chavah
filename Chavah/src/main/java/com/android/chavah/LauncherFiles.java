...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.android.chavah.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.android.chavah.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.android.chavah.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "com.android.chavah.compat.PackageInstallerCompatV16.queue"));
}
